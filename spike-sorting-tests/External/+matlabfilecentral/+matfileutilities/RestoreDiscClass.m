...
% functions to ensure that adequate bytes has been set aside to store
...
%__________________________________________________________________________
import matlabfilecentral.matfileutilities.*
...
if isreal(var) && strcmp(w.DiscClass{1}, class(var))==1 
    return
end
if ~isreal(var) &&...
