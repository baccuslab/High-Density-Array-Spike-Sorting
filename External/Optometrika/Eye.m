classdef Eye < Bench
    ...
    % INPUT:
    %   lens_diameter - eye lens diameter, mm, specifies the eye's accomodative state
    %   pupil_diameter - eye pupil diameter, mm
    % OUTPUT:
    %   e - eye object
    %
    ...
    properties ( Constant )
        ...
        Cornea1k = -0.10  % front conic cosntant (30-year old, Goncharov et al. 2009, Escudero-Sanz et al. 1999 uses -0.26
        Cornea1x = -13.3  % surface position wrt eye center of rotation
        Cornea2D = 11     % back surface diameter
        ...
        LensV2   = 106.66 % constant volume of the lens parablolic part
        % retina
    ...
    methods
        ...
        function self = Eye( lens_diameter, pupil_diameter )
            ...
            % pupil
            pupil = Aperture( [ self.Pupilx 0 0 ], self.PupilD, self.PupilDout );
            self.cnt = self.cnt + 1;
