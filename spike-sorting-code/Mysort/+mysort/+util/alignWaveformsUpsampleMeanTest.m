function alignWaveformsUpsampleMeanTest()
    warning('This function is depricated! Use mysort.wf.* instead!');
    nS = 100;
    nC = 2;

    X = repmat([[5:-.5:0 1:10 10:-1:1 0:.5:5]-5 -[5:-.5:0 1:10 10:-1:1 0:.5:5]+5], nS, nC/2);
    X = X + randn(size(X));
    shifts = [-8:2:8 9];
...
%     title('Aligned Spikes');
    ...
    [tau Y] = mysort.util.alignWaveformsUpsampleMean(X, 2, 'maxIdx', 20);
