%% INIT FELIX
% matlabpool(12);
ian_data_path = '/net/bs-filesvr01/export/group/hierlemann/projects/retina_project/ijones_data/hamster_retina_data_and_sorting_01/';
...
c = load(confListFile);
flist_file = fullfile(ian_data_path, expName, 'flist_run_01.m');
flist = {};
run(flist_file)
